    ...
    >
     ...
     <el-form-item label="Create Time">
      ...
      <el-form-item>
        ...
        v-loading="listLoading" v-if="hasPerm('comment.list')"
        >
        ...
        <el-table-column label="Operation" width="200" align="center">
            <template slot-scope="scope">
            <router-link :to="'/edu/comment/edit/' + scope.row.id">
                <el-button type="primary" size="mini" icon="el-icon-edit" v-if="hasPerm('comment.update')"
                >Edit</el-button
                >
            </router-link>
            <el-button
                ...
                size="mini"
                icon="el-icon-delete"
                @click="removeDataById(scope.row.id)" v-if="hasPerm('comment.remove')"
                >Delete</el-button
            >
