<template>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-table-column prop="title" label="Course Title" width="390"> </el-table-column>

        <el-table-column label="Course Status" width="160">
            <template slot-scope="scope">
            {{ scope.row.status === "Normal" ? "Published" : "Not Published" }}
            </template>
        </el-table-column>

        <el-table-column prop="lessonNum" label="Course Hour" width="80" />
        <el-table-column prop="gmtCreate" label="Create Time" width="193" />
        <el-table-column prop="viewCount" label="Views" width="100" /> 
<!-- liu lan shu liang -->
        <el-table-column label="Operation" width="225" align="center">
            <template slot-scope="scope">
