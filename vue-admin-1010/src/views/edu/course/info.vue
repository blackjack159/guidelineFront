      ...
      addCourse(){
        course.addCourseInfo(this.courseInfo)
            .then(response => {
                ...
                this.$router.push({path:'/edu/course/chapter/'+response.data.courseId}) //id for course_description table
            })
      },
      updateCourse(){
          course.updateCourseInfo(this.courseInfo)
            .then(response =>{
                ...
                //proceed to next step
                this.$router.push({path:'/edu/course/chapter/'+this.courseId}) //the update method won't return courseId
            })
      },
       saveOrUpdate(){
