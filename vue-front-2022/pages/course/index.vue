        ...
        <section class="c-s-dl">
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li>
                  <a title="全部" href="/course"  :class="{active:oneIndex==-1}">All</a>
                </li>
       ...
       <li :class="{ 'current bg-orange': buyCountSort != '' }">
        ...
        <div class="mt40">
          ...
          <section class="no-data-wrap" v-if="data.total==0">
            ...
            <span class="c-666 fsize14 ml10 vam">No related course for this subject...</span>
          </section>
          <!-- /无数据提示 结束-->
              ...
              <li v-for="item in data.items" :key="item.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    ...
                    <div class="cc-mask">
                      <a :href="'/course/'+item.id" title="开始学习" class="comm-btn c-btn-1">Start!</a>
                    </div>
                  </section>
                  ...
                  <section class="mt10 hLh20 of" v-if="Number(item.price) === 0">
                    ...
                    <section class="mt10 hLh20 of" v-else>
                      ...
                      <span class="fl jgAttr c-ccc f-fA">
                        <i class="c-999 f-fA">{{item.viewCount}} Views</i>
                        |
                        <i class="c-999 f-fA">{{item.buyCount}} Buy</i>
                      </span>
                    </section>
